...
public class AutoUpdateAlarm extends BroadcastReceiver {
    ...
    public void setAlarmForPeriodicUpdate(Context context) {
        ...
        am.setRepeating(AlarmManager.RTC_WAKEUP, getMillisUntilTriggerTime(22), AlarmManager.INTERVAL_HALF_HOUR, pi);
//        am.setRepeating(AlarmManager.RTC_WAKEUP, System.currentTimeMillis() + 60 * 60 * 1000, 1000 * 60, pi); // FIXME: 5/31/17 remove debug code
    }
